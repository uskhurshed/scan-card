...
public:
    ...
    virtual bool SetRawFrame(const Mat& rawFrame, const vector<ParametricLine>& edges, RecognizerOrientation orientation) = 0;
    
    virtual bool NormalizeMatrix(const Mat& matrix, const vector<ParametricLine>& edges, Mat& resultMatrix) = 0;
    
    virtual void SetRawY(const void* rawY, const void* rawUV, const vector<ParametricLine>& edges, RecognizerOrientation orientation) = 0;
    ...
    virtual const RecognizerOrientation GetYUVOrientation() = 0;
};
