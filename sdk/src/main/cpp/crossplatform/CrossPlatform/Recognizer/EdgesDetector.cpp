...
CEdgesDetector::CEdgesDetector(shared_ptr<IFrameStorage> frameStorage) : _lineFlags(DetectedLineNoneFlag), _orientation(RecognizerOrientationUnknown)
{
}
...
const Rect CEdgesDetector::CalcWorkingArea(Size frameSize, int captureAreaWidth,
                                           RecognizerOrientation orienation)
{
    ...
    if (orienation == RecognizerOrientationPortrait || orienation == RecognizerOrientationPortraitUpsideDown) {
...
{
    if (_orientation == RecognizerOrientationUnknown)
    ...
    if(BestLine(&topLine, topEdge, false)) {
        ...
        if (_orientation == RecognizerOrientationPortrait || _orientation == RecognizerOrientationPortraitUpsideDown) {
