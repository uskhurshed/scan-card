...
import scan.ndk.RecognitionCore;
...
public final class RecognitionAvailabilityChecker {
    ...
    public static boolean isDeviceHasCamera(Context context) {
        ...
        boolean hasCameraFeature = false;
        if (android.os.Build.VERSION.SDK_INT > Build.VERSION_CODES.JELLY_BEAN) {
            hasCameraFeature = pm.hasSystemFeature(PackageManager.FEATURE_CAMERA_ANY);
        }else{
    ...
    public static class Result {
        ...
        public String toString() {
            return String.format(Locale.US, "Is new enough: %s, has camera: %s, has camera permission: %s, recognition library supported: %s, camera supported: %s",
