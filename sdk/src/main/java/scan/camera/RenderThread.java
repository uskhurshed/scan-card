...
import scan.camera.gles.Drawable2d;
import scan.camera.gles.EglCore;
import scan.camera.gles.GlUtil;
import scan.camera.gles.Sprite2d;
import scan.camera.gles.Texture2dProgram;
import scan.camera.gles.WindowSurface;
import scan.ndk.TorchStatusListener;
        ...
        try {
            ...
            mCameraManager.setProcessFrameCallbacks(new ProcessFrameThread.Callbacks() {
                ...
                public void onFpsReport(String report) {
                    mMainHandler.sendFpsReport(report);
                }
            });
            ...
            assert mCameraManager.getCamera() != null;
