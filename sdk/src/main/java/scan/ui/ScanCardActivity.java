...
import scan.camera.RecognitionAvailabilityChecker;
import scan.camera.RecognitionCoreUtils;
import scan.camera.RecognitionUnavailableException;
...
public class ScanCardActivity extends AppCompatActivity implements ScanCardFragment.InteractionListener,
    ...
    private void showScanCard() {
        ...
        // Apply insets to the root view for edge-to-edge support
